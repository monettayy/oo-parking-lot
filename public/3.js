...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/src/pages/Settings/Slots.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/src/pages/Settings/Slots.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getItems: function getItems() {
      ...
      this.isLoading = true;
      this.slots = '';
      axios.get("/slots/list", {
        params: this.filters
      }).then(function (response) {
        _this.isLoading = false;

        if (response.data.status == "OK") {
          _this.slots = response.data.data;
        }
      })["catch"](function () {
        _this.isLoading = false;
    ...
    deleteItem: function deleteItem(item) {
      ...
      this.$confirm("", "Are you sure you want to delete this slot?", 'question').then(function () {
        _this2.$loader.show();

        axios["delete"]('/slot/' + item.id).then(function (response) {
          _this2.$loader.hide();

          if (response.data.status == "OK") {
            _this2.$alert("", "Slot was deleted", 'success', {
              timer: 1000,
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/src/pages/Settings/Slots.vue?vue&type=template&id=33b82c77&":
/*!*******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./resources/src/pages/Settings/Slots.vue?vue&type=template&id=33b82c77& ***!
  \*******************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function render() {
  ...
  }, [_vm._m(1), _vm._v(" "), !_vm.isLoading && _vm.slots && _vm.slots.data.length > 0 ? _c("tbody", _vm._l(_vm.slots.data, function (item, i) {
    return _c("tr", {
      staticClass: "bg-white"
    }, [_c("td", {
      staticClass: "text-center"
    }, [_vm._v(_vm._s(_vm._f("getNumber")(i, _vm.filters.page, _vm.slots.per_page)))]), _vm._v(" "), item.entrance ? _c("td", [_vm._v(_vm._s(item.entrance.name))]) : _c("td", [_vm._v("---")]), _vm._v(" "), item.slot_type ? _c("td", [_vm._v(_vm._s(item.slot_type.name))]) : _c("td", [_vm._v("---")]), _vm._v(" "), _c("td", [_vm._v(_vm._s(item.distance))]), _vm._v(" "), _c("td", [_c("a", {
      staticClass: "btn btn-primary btn-sm",
      attrs: {
        href: "/slots/edit/" + item.code
      }
    }, [_c("i", {
  ...
  }), 0) : _vm._e(), _vm._v(" "), !_vm.isLoading && _vm.slots && _vm.slots.data.length == 0 ? _c("tbody", [_vm._m(2)]) : _vm._e(), _vm._v(" "), _vm.isLoading && !_vm.slots ? _c("tbody", [_c("tr", {
    staticClass: "bg-white"
  }, [_c("td", {
    staticClass: "text-center",
    attrs: {
  ...
  }, [_c("data-loader")], 1)])]) : _vm._e()])]), _vm._v(" "), _vm.slots && _vm.slots.data.length > 0 ? _c("Pagination", _vm._b({
    on: {
      pageClicked: _vm.getItems
    }
  }, "Pagination", {
    _lastPage: _vm.slots.last_page,
    _page: _vm.filters.page,
    _total: _vm.slots.total,
    _per_page: _vm.slots.per_page,
    _to: _vm.slots.to
  }, false)) : _vm._e()], 1)]);
};
...
var staticRenderFns = [function () {
  ...
  }, [_c("tr", [_c("th", [_vm._v("#")]), _vm._v(" "), _c("th", [_vm._v("Entrance")]), _vm._v(" "), _c("th", [_vm._v("Slot Type")]), _vm._v(" "), _c("th", [_vm._v("Distance")]), _vm._v(" "), _c("th", [_vm._v("Action")])])]);
}, function () {
  var _vm = this,
      _c = _vm._self._c;
...
/***/ "./resources/src/pages/Settings/Slots.vue":
/*!************************************************!*\
  !*** ./resources/src/pages/Settings/Slots.vue ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Slots_vue_vue_type_template_id_33b82c77___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Slots.vue?vue&type=template&id=33b82c77& */ "./resources/src/pages/Settings/Slots.vue?vue&type=template&id=33b82c77&");
/* harmony import */ var _Slots_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Slots.vue?vue&type=script&lang=js& */ "./resources/src/pages/Settings/Slots.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Slots_vue_vue_type_template_id_33b82c77___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Slots_vue_vue_type_template_id_33b82c77___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/src/pages/Settings/Slots.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/src/pages/Settings/Slots.vue?vue&type=script&lang=js&":
/*!*************************************************************************!*\
  !*** ./resources/src/pages/Settings/Slots.vue?vue&type=script&lang=js& ***!
  \*************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Slots_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./Slots.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/src/pages/Settings/Slots.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Slots_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/src/pages/Settings/Slots.vue?vue&type=template&id=33b82c77&":
/*!*******************************************************************************!*\
  !*** ./resources/src/pages/Settings/Slots.vue?vue&type=template&id=33b82c77& ***!
  \*******************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Slots_vue_vue_type_template_id_33b82c77___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!../../../../node_modules/vue-loader/lib??vue-loader-options!./Slots.vue?vue&type=template&id=33b82c77& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/src/pages/Settings/Slots.vue?vue&type=template&id=33b82c77&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Slots_vue_vue_type_template_id_33b82c77___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Slots_vue_vue_type_template_id_33b82c77___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
